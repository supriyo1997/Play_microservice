...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """create""", """controllers.HomeController.save(request:Request)"""),
  ...
  private[this] lazy val controllers_HomeController_save1_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      HomeController_1.save(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "save",
